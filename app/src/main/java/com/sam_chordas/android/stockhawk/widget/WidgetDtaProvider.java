...
/**
 * Created by Samir Thebti  on 18/10/16.
 * ----->> thebtisam@gmail.com <<-----
 */

public class WidgetDtaProvider implements RemoteViewsFactory {
    public static final String TAG = WidgetDtaProvider.class.getSimpleName();
    private Context mContext;
    private Cursor mCursor;
    private int appWidgetId;

    public WidgetDtaProvider(Context mContext, Intent mIntent) {
    ...
    public void onCreate() {
        Log.d(TAG, "onCreate: ");
        mCursor = mContext.getContentResolver().query(Quotes.CONTENT_URI,
